...
If we use $v_p = 6009 \quad m/s$ and $v_s = 3212 \quad m/s$ for steel, the value of $ka/\pi$ is the same as that of Lamb (1881), which corresponds to a frequency of $135,276 \quad Hz$ or about $136,000 \quad Hz$ as he estimates. 
